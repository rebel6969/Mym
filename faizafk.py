...
class AFKMod(loader.Module):
    ...
    async def afkcmd(self, message):
        ...
        await message.edit(_("<code>Ma senpai is goin' AFK</code>"))
    ...
    async def unafkcmd(self, message):
        ...
        await message.edit(_("<code>My senpai no longer AFK</code>"))
    ...
    async def watcher(self, message):
        if message.mentioned or getattr(message.to_id, 'user_id', None) == self._me.id:
            ...
            if user.is_self or user.bot or user.verified:
                ...
                afktime = "My senpai has been afk for " + str(years) + " years " + str(months) + " months " + str(days)
                ...
                if seconds == 0:
                    ...
                    pass
                reply = f"My senpai is afk right now. \nReason: " + afkreason + "\n\n" + afktime
